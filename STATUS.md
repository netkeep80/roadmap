...
- Last successful GitHub check: **2026-08-28T11:25:51.380Z**
- Latest observed GitHub change in snapshot: **2026-08-28T11:19:26Z**
- State hash (excluding check time): `d6cbdd363b48de7f579bcbfc35bab354c1c453a012a3d5332d8f0805f443dae5`
...
| **P1** | [`PersistMemoryManager`](https://github.com/netkeep80/PersistMemoryManager) | `active` | закрыть consumer-shaped readiness для native persistent object storage pjson | #410/#415/#416/#426 → #421 | 13 issues / 3 PRs | [#2](https://github.com/netkeep80/roadmap/issues/2) |
...
| **P1** | [`roadmap`](https://github.com/netkeep80/roadmap) | `control-plane` | быть единой точкой входа для актуального состояния, зависимостей, решений и направления развития всего portfolio | ongoing: поддерживать live control loop и явно reconciliate detected semantic drift | 45 issues / 0 PRs | [#1](https://github.com/netkeep80/roadmap/issues/1), [#13](https://github.com/netkeep80/roadmap/issues/13), [#16](https://github.com/netkeep80/roadmap/issues/16) |
...
- ✅ [#157](https://github.com/netkeep80/aprover/issues/157) `closed` — [R3] Functional mathematical prover: theorem library → deterministic search → C1-C6 corpus
...
|---|---|---:|---|---:|---:|
| [`anum_docs`](https://github.com/netkeep80/anum_docs) | `main` | no | 2026-08-28T11:19:26Z | 12 | 2 |
| [`aprover`](https://github.com/netkeep80/aprover) | `main` | no | 2026-08-28T08:21:33Z | 4 | 0 |
...
| [`PersistMemoryManager`](https://github.com/netkeep80/PersistMemoryManager) | `main` | no | 2026-08-28T10:43:18Z | 13 | 3 |
| [`pjson`](https://github.com/netkeep80/pjson) | `main` | no | 2026-08-09T09:56:53Z | 17 | 0 |
| [`repo-guard`](https://github.com/netkeep80/repo-guard) | `main` | no | 2026-08-28T11:16:33Z | 7 | 1 |
| [`roadmap`](https://github.com/netkeep80/roadmap) | `main` | no | 2026-08-28T10:25:20Z | 45 | 0 |
...
- ✅ [#410](https://github.com/netkeep80/PersistMemoryManager/issues/410) `closed` — Compaction: eliminate forest_domain_mixin.inc and fix registry relocation lifetimes
